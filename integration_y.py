...
# Load the CSV file
df = pd.read_csv('position_3.csv', usecols=['timestamp', 'acc_y'], on_bad_lines='skip')

# Clean the data (remove rows with missing values)
df = df.dropna(subset=['timestamp', 'acc_y'])
...
velocity = cumulative_trapezoid(acc_y, x=t, initial=0)
