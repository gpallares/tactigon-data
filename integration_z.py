...
# Load the CSV file
df = pd.read_csv('position_3.csv', usecols=['timestamp', 'acc_z'], on_bad_lines='skip')

# Clean the data (remove rows with missing values)
df = df.dropna(subset=['timestamp', 'acc_z'])
...
velocity = cumulative_trapezoid(acc_z, x=t, initial=0)
